...
function onDataReceived(series) {
	var tableStr = "<table class=\"styledTable\"><tr><th>ID</th><th>Name&nbsp;&nbsp;&nbsp;&nbsp;</th><th>Team&nbsp;&nbsp;</th></tr>";
	var classA = "a";var classB = "b";var classId;    
	for (var i = 0; i <= 4; i++) {
		if(series[i][2] == 'A'){
			classId = classA;
		} else{
        	...
        	tableStr = tableStr + "<tr class="+classId+"><td>"+series[i][0]+"</td><td>"+series[i][1]+"&nbsp;&nbsp;&nbsp;&nbsp;</td><td align=\"right\">"+series[i][2]+"&nbsp;&nbsp;</td></tr>";
    	} 
